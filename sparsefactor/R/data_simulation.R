...
#' @param tauvec Vector of feature-specific precisions of the noise. If \code{NULL}, this will be simulated.
#' @param fmat Matrix of activation weights. If \code{NULL}, this will be simulated.
...
#' @param taushape Shape hyperparameter of the gamma prior for simulating the feature-specific precision of the noise.
#' @param taurate Rate hyperparameter of the gamma prior for simulating the feature-specific precision of the noise.
#' @param alphashape Shape hyperparameter of the gamma prior for simulating the factor-specific precision of the loading factors.
#' @param alpharate Rate hyperparameter of the gamma prior for simulating the factor-specific precision of the loading factors.
#'
