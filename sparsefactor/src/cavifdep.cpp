...
void initialise_fdep(arma::mat &ymat, arma::vec &pivec,
...
void permute_fdep(arma::vec &pivec,
                  arma::mat &lmeans, arma::mat &lsigs,
                  arma::mat &fmeans, arma::mat &fcovs, arma::mat &zmeans,
                  arma::vec &alphashapes, arma::vec &alpharates);
...
List cavi_fdep(arma::mat &ymat, arma::vec &pivec,
    ...
    initialise_fdep(ymat, pivec, lmeans, lsigs, fmeans, fcovs, zmeans,
    ...
    while((iter < max_iter) && (diff_elbo >= tol_elbo) && (rel_diff >= EPS) && (diff_z >= tol_z)) {
        ...
        if(iter % check == 0) {
            prev_z = zmeans;
            prev_elbo= calc_elbo_fdep(ymat, pivec, lmeans, lsigs, fmeans, fcovs, zmeans,
                             taushapes, taurates, alphashapes, alpharates,
        ...
        permute_fdep(pivec, lmeans, lsigs, fmeans, fcovs, zmeans, alphashapes, alpharates);

        // for elbo convergence
        if(iter % check == 0) {
            curr_elbo= calc_elbo_fdep(ymat, pivec, lmeans, lsigs, fmeans, fcovs, zmeans,
                             taushapes, taurates, alphashapes, alpharates,
                             ptaushape, ptaurate, palphashape, palpharate);
...
void update_f_fdep(arma::mat &ymat, arma::mat &lmeans, arma::mat &lsigs,
    ...
    fcovs = arma::inv_sympd(ltaul_bar + arma::eye(K, K));
...
void update_tau_fdep(arma::mat &ymat, arma::mat &lmeans, arma::mat &lsigs,
    ...
    arma::mat ff_bar = N * fcovs + fmeans * fmeans.t();
...
double calc_elbo_fdep(arma::mat &ymat, arma::vec &pivec,
    ...
    elbo -= 0.5 * (N * arma::trace(fcovs) + arma::accu(arma::square(fmeans)));
    ...
    elbo += 0.5 * N * (K + log(arma::det(fcovs)));
